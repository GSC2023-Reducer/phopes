...
class _IdLoginPage extends State<IdLoginPage> with SingleTickerProviderStateMixin{
  ...
  void initState(){
    ...
    userList.add(User(userName : "호날두", id : "ronaldo", password: "cr7", createTime: DateTime.utc(2023,2,20)));
    userList.add(User(userName : "메시", id : "messi", password: "lm10", createTime: DateTime.utc(2023,2,19)));
    userList.add(User(userName : "음바페", id : "mbappe", password: "km10", createTime: DateTime.utc(2023,2,18)));
        ...
        child : Column(
          ...
          children: <Widget>[
                ...
                SizedBox(
                    child: Checkbox(
                      ...
                      side: MaterialStateBorderSide.resolveWith(
                            (states) => BorderSide(width: 1.0, color: Color(0xffDBDBDB)),
                      ),
                    )
                ),
                SizedBox(
            ...
            MaterialButton(
                    ...
                    makeDialog("아이디와 비밀번호를 입력하세요");
                      ...
                      if(idCheck(_idTextController?.value.text) == -1){
                        ...
                        makeDialog('아이디가 없습니다');
                          ...
                          if(_pwTextController?.value.text == userList[idCheck(_idTextController?.value.text)]){
                ...
                child: Text("로그인", style : TextStyle(fontFamily: 'NotoSansKR',
                    fontWeight: FontWeight.w500,
